...
export class StyleSettings extends Component {
	...
	getPosition(GfSocialIconsSettings) {
		const currentPosition = GfSocialIconsSettings["styleSettings"].styles["--gutefy-icon-wrapper-position-right"]
            ? GfSocialIconsSettings["styleSettings"].styles["--gutefy-icon-wrapper-position-right"] : this.state.IconPosition;
		...
		api.loadPromise.then(() => {
			...
			if (isAPILoaded === false) {
				this.settings.fetch().then((response) => {
					...
					this.setState({
						IconColor: GfSocialIconsSettings["styleSettings"].styles[
							"--gutefy-icon-color"
						]
							? GfSocialIconsSettings["styleSettings"].styles[
									"--gutefy-icon-color"
							  ]
							: this.state.IconColor,
						IconWrapperColor: GfSocialIconsSettings["styleSettings"].styles[
						...
						IconHoverColor: GfSocialIconsSettings["styleSettings"].styles[
						...
						IconWrapperHoverColor: GfSocialIconsSettings["styleSettings"]
							.styles["--gutefy-icon-wrapper-hover-color"]
							? GfSocialIconsSettings["styleSettings"].styles[
									"--gutefy-icon-wrapper-hover-color"
							  ]
							: this.state.IconWrapperHoverColor,
						IconPosition: IconPosition,
						IconPositionTop: GfSocialIconsSettings["styleSettings"].styles[
						...
						IconSize: GfSocialIconsSettings["styleSettings"].styles[
							"--gutefy-icon-size"
						]
							? GfSocialIconsSettings["styleSettings"].styles[
									"--gutefy-icon-size"
							...
							: this.state.IconSize,
						IconWrapperSize: GfSocialIconsSettings["styleSettings"].styles[
		...
		return (
			<Fragment>
				<div className="gf-social-icons__main-wrapper">
					...
					<Panel>
						<PanelBody
							className="gf-social-icons-panel__body"
							initialOpen={false}
							title={__("Color Settings", "gf-social-icons")}
							icon=""
						>
							<div className="gf-social-icons-panel__body_wrapper">
								<ColorControl
									label={"Icon Color"}
									value={IconColor}
									targetedSelector={"--gutefy-icon-color"}
								/>

								<ColorControl
									label={"Wrapper Background"}
									value={IconWrapperColor}
									targetedSelector={"--gutefy-icon-wrapper-color"}
								/>
							</div>
							<PanelBody
								className="gf-social-icons-panel__body"
								initialOpen={false}
								title={__("Hover Style", "gf-social-icons")}
								icon=""
							>
								<div className="gf-social-icons-panel__body_wrapper">
									<ColorControl
										...
										targetedSelector={"--gutefy-icon-hover-color"}
									/>
									<ColorControl
										label={"Wrapper Background"}
										value={IconWrapperHoverColor}
										targetedSelector={"--gutefy-icon-wrapper-hover-color"}
									/>
								</div>
							</PanelBody>
						</PanelBody>
					...
					<Panel>
						<PanelBody
							className="gf-social-icons-panel__body"
							initialOpen={false}
							title={__("Positioning & Size Settings", "gf-social-icons")}
							icon=""
						>
							<div className="gf-social-icons-panel__body_wrapper">
								<PositioningControl
									label="Icon Position"
									value={IconPosition}
									verticalValue={IconPositionTop}
								/>
							</div>
							<PanelBody
								className="gf-social-icons-panel__body"
								initialOpen={false}
								title={__("Size", "gf-social-icons")}
								icon=""
							>
								<div className="gf-social-icons-panel__body_wrapper ">
									<AdvUnitControl
										label={"Icon Size"}
										targetSelector={"--gutefy-icon-size"}
										value={IconSize}
									/>
									<AdvUnitControl
										label={"Icon Wrapper Size"}
										targetSelector={"--gutefy-icon-wrapper-size"}
										value={IconWrapperSize}
									/>
								</div>
							</PanelBody>
						</PanelBody>
